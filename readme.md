...
| 이성희 | 팀원,기획, 디자인, 구현, GIt 담장     | 현황분석(반응형)<br>벤치마킹(반응형 웹)<br>HERO section, HERO Mega Menu section, Frontend section                                                                   | [@xoxoworld](https://github.com/xoxoworld)     | sung021125@gmail.com        |
...
| 주성문 | 팀원, 기획, 디자인, 구현, 피그마 담당 | 현황분석(합목적성)<br>벤치마킹(내용)<br>Student Benefits Section, Section - Recruitment Overview, Section - FAQ                                                     | [@ KimShueBang](https://github.com/jiwoo-park) | jiwoo@example.com           |
